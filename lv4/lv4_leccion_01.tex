...
\begin{VocabTable}[0.20\linewidth][→][P,P]
...
\begin{VocabTable}[0.30\linewidth][→][P,P]
  \ruby{兄}{あに} & Hermano mayor (propio). \\
  お\ruby{兄}{にい}さん & Hermano mayor (de otro). \\
  \ruby{弟}{おとうと} & Hermano menor (propio). \\
  \ruby{姉}{あね} & Hermana mayor (propia). \\
  お\ruby{姉}{ねえ}さん & Hermana mayor (de otro). \\
  \ruby{妹}{いもうと} & Hermana menor (propia). \\
\end{VocabTable}
...
\begin{VocabTable}[0.45\linewidth][→][P,P]
