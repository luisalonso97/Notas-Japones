...
\usepackage{kanjicard}

\begin{document}
\pagestyle{empty}
\maketitle{}

\begin{kanjicard}{口}{コウ}{くち}
  \KExample{口}{ぐち}{Boca}
...
\begin{kanjicard}{百}{}{ヒアク・ビアク・ピアク}
  \KExample{二百}{に・ひゃく}{２００}
  \KExample{三百}{さん・びゃく}{３００}
  \KExample{六百}{ろ・ぴゃく}{６００}
  \KExample{八百}{はっ・ぴゃく}{８００}
\end{kanjicard}

\begin{kanjicard}{千}{ち}{セン・ゼン}
  \KExample{千円}{せん・えん}{１０００ yenes}
  \KExample{三千}{さん・ぜん}{３０００}
\end{kanjicard}

\begin{kanjicard}{万}{}{マン・バン}
  \KExample{一万円}{いち・まん・えん}{１０００ yenes}
